...
export function SportsbookProvider({
  ...
  const { getActiveSportsbooks, updatePreferences, preferences } = usePreferences();
  const selectedSportsbooks = preferences?.preferred_sportsbooks || getActiveSportsbooks();
  ...
  const setUserSportsbooks = (sportsbooks: string[]) => {
    void updatePreferences({ preferred_sportsbooks: sportsbooks });
  };
