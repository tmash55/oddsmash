...
import { OddsFilters } from '@/components/odds/filters'
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-2 sm:px-4 py-4">
        ...
        <PageLoader 
          title={`Loading ${sport.toUpperCase()} Odds`}
          subtitle="Fetching the latest odds and market data..."
        />
      </div>
    )
  }
...
export default function SportOddsPage(props: { params: { sport: string } }) {
  return (
