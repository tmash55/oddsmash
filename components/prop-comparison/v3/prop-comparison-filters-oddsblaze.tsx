...
interface PropComparisonFiltersOddsBlazeProps {
  market: string
...
export function PropComparisonFiltersOddsBlaze({
  market,
  onMarketChange,
  searchQuery,
  onSearchChange,
  ...
  preGameCount = 0,
  liveCount = 0,
}: PropComparisonFiltersOddsBlazeProps) {
          ...
          <div className="px-4 pb-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center rounded-2xl border px-1 py-1 bg-white/50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-800">
                <button
                  type="button"
                  className={`px-3 py-1.5 rounded-xl text-sm font-medium ${mode === 'pregame' ? 'bg-slate-900 text-white dark:bg-white dark:text-slate-900 shadow' : 'text-slate-600 dark:text-slate-300'}`}
              ...
              {selectedSportsbook && (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">{getSportsbookById(selectedSportsbook)?.name}</span>
                  </div>
                  <Button
                    variant="ghost"
                    size="icon"
