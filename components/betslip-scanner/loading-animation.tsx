    ...
    <div className="container mx-auto py-16 px-4 max-w-2xl">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            <motion.div
              ...
              className={`p-3 rounded-full bg-gradient-to-r ${currentStage.color} shadow-lg`}
            >
              ...
              <div key={stageItem.id} className="flex items-center">
                ...
                >
                  {isCompleted ? (
                    ...
                    <stageItem.icon className={`w-6 h-6 ${isActive ? "text-white" : "text-slate-400"}`} />
                  )}
      ...
      >
        <div className="bg-white dark:bg-slate-800 rounded-lg p-4 border border-slate-200 dark:border-slate-700 shadow-sm">
          ...
          <div className="text-xs text-slate-600 dark:text-slate-400">Selections Found</div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg p-4 border border-slate-200 dark:border-slate-700 shadow-sm">
          <motion.div
            className="text-2xl font-bold text-green-400 mb-1 flex items-center justify-center"
      ...
      {/* Enhanced Selection Preview Cards */}
      <AnimatePresence>
            ...
            {selections.slice(0, 3).map((selection, index) => (
              ...
              >
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-slate-900 dark:text-slate-100 truncate">{selection.player}</p>
                  <p className="text-sm text-slate-600 dark:text-slate-400 truncate">{selection.market}</p>
                </div>
                <div className="text-right">
                  <motion.span
                    className={`font-bold ${currentStage.textColor}`}
                    animate={{ scale: [1, 1.05, 1] }}
      ...
      {stage === "complete" && (
        <motion.div
          ...
          className="text-center bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 shadow-lg"
        >
          <motion.div
            animate={{
              rotate: [0, 10, -10, 0],
