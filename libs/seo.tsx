...
export const getSEOTags = ({
  ...
  return {
    ...
    openGraph: {
      ...
      // If you add an opengraph-image-v2.(jpg|jpeg|png|gif) image to the /app folder, you don't need the code below
      // images: [
      //   {
    ...
    twitter: {
      title: openGraph?.title || config.appName,
      description: openGraph?.description || config.appDescription,
      // If you add an twitter-image-v2.(jpg|jpeg|png|gif) image to the /app folder, you don't need the code below
